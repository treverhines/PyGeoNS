...
pygeons-tgpr work/data.h5 $STD $CLS \
             --output_file work/smooth_disp.h5
# compare the observed and smoothed displacements
pygeons-view work/data.h5 work/smooth_disp.h5 \
             --data_set_labels 'observed' 'smoothed' \
...
pygeons-sgpr work/vel.h5 $STD $CLS \
             --output_file work/smooth_vel.h5
# view the smoothed velocities
pygeons-view work/smooth_vel.h5 \
             --data_set_labels 'velocities' \
             --image_resolution 400
...
pygeons-sgpr work/vel.h5 $STD $CLS \
             --diff 1 0 \
             --output_file work/xdiff.h5
# Compute y derivative of velocities
pygeons-sgpr work/vel.h5 $STD $CLS \
             --diff 0 1 \
             --output_file work/ydiff.h5
