...
pygeons-ssmooth data/synthetic.noise.clean.h5 --length_scale 50000

# compute x derivative of the smoothed and unsmoothed data
pygeons-diff --dx 1 data/synthetic.noise.clean.h5 
pygeons-diff --dx 1 data/synthetic.noise.clean.ssmooth.h5 

pygeons-view data/synthetic.noise.clean.h5 \
             data/synthetic.noise.clean.ssmooth.h5 \
             --data_set_names noisy smooth

pygeons-view data/synthetic.noise.clean.diff.h5 \
             data/synthetic.noise.clean.ssmooth.diff.h5 \
             --data_set_names noisy smooth
