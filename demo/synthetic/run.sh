...
pygeons-tfilter data/synthetic.h5 --cutoff 0.01 --diff 1 --break_dates 2001-01-01 -vv --procs 6

# spatial x derivative
pygeons-sfilter data/synthetic.tfilter.h5 --diff 1 0 --cutoff 0.00001 \
...
--break_lats2 43.6001605868 42.3336 44.3666 -vv --procs 6 --output_file data/diffx.h5

# spatial y derivative
pygeons-sfilter data/synthetic.tfilter.h5 --diff 0 1 --cutoff 0.00001 \
--break_lons1 -85.3530628568 -85.3530628568 -83.0353452111 \
--break_lats1 42.9880621292 42.9880621292 43.6001605868 \
--break_lons2 -83.0353452111 -87.3166 -81.5607 \
--break_lats2 43.6001605868 42.3336 44.3666 -vv --procs 6 --output_file data/diffy.h5
...
pygeons-strain data/diffx.h5 data/diffy.h5 -vv --scale 100000000000.0
